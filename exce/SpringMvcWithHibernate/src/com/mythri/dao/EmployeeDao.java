...
public class EmployeeDao {
	...
	public List<Employee> getAllEmployeesWithoutLogin(Integer id) {
		Session session = sessionFactory.openSession();
	...
	public void updateEmployee(final Employee newEmpDetails) {//newEmpDetails-new data 
			Session session = sessionFactory.openSession();
			Transaction transaction = session.getTransaction();
			transaction.begin();
			
			//get current data
			Employee empFromDB = getEmpById(newEmpDetails.getId());//empFromDB- old data
