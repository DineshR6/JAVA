...
public class Ex5 {
	...
	public static void main(String[] args) {
		...
		int even = numbers.stream().filter(x -> x % 2 == 0).reduce(0, (x, y) -> x + y);
...
// demonstration of max method 
		...
		boolean answer2 = numbers.stream().anyMatch(n -> (n * (n + 1)) / 4 == 5);
...
//terminal operations
		...
		boolean answer3 = numbers.stream().allMatch(n -> n % 3 == 0);
