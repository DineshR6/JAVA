...
public class Hdfc extends Rbi {
	 ...
	 * RBI r = new Hdfc(); // create obj for child class and refer by parent
	 * class.[upcasting]
	 * 
	 * //Hdfc r2 = new RBI(); -- create obj for parent class and refer by child
	 * class.- not possible and it gives compilation
	 */
}